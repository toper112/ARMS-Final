<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="LRN" class="block mt-1 w-full" type="number" name="LRN" :value="old('LRN')" required autocomplete="LRN" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="section" class="block mt-1 w-full" type="text" name="section" :value="old('section')" required autocomplete="section" />
